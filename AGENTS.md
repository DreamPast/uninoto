...
- As of the 2026-06-17 merge with explicit styles and de-duplicated directional extra, Unicode 17 visible codepoint coverage is: `regular` sans/serif with extra 96293/159631 (60.323%), `bold` sans/serif with extra 55727/159631 (34.910%), `italic` sans/serif with extra 3164/159631 (1.982%), `bolditalic` sans/serif with extra 3125/159631 (1.958%), `full` sans with directional extra 159523/159631 (99.932%), `full` serif with directional extra 159525/159631 (99.934%), and `full` mono 159430/159631 (99.874%). Remaining `full` sans/serif visible gaps are recorded in `fonts\reports\full\*-missing-visible.csv` and currently include several blank/space codepoints plus Unicode 16 codepoints. Check `fonts/reports/*-missing-visible.csv` before claiming full coverage.
